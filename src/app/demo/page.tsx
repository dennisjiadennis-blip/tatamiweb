export default function DemoPage() {
  return (
    <div style={{ 
      ...
      <p style={{ fontSize: '1.25rem', marginBottom: '2rem', color: '#dc2626' }}>
        深度对话体验，连接全球与日本大师
      </p>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <h3 style={{ color: '#f59e0b', marginBottom: '1rem' }}>部署建议</h3>
          <p style={{ fontSize: '0.9rem', lineHeight: '1.6' }}>
            目前为了解决openid-client兼容性问题，暂时移除了middleware。在生产环境部署时，可以：
          </p>
          <ul style={{ textAlign: 'left', marginTop: '1rem', fontSize: '0.9rem' }}>
            <li>使用API路由进行服务端认证</li>
            <li>采用客户端路由进行语言切换</li>
            <li>或部署到Node.js runtime环境</li>
          </ul>
        </div>
